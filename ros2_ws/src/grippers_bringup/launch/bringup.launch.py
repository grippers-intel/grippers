...
def launch_setup(context):
    ...
    perception_node = Node(
        package='grippers_perception', executable='perception_node', output='screen',
    ...
    grippers_nodes = [
        ...
        Node(
            package='grippers_mission', executable='mission_orchestrator', output='screen',
...
def generate_launch_description():
    return LaunchDescription([
        DeclareLaunchArgument(
            'use_fake_perception', default_value='true',
