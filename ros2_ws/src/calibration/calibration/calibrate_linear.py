...
import threading
import time
from math import copysign, pow, sqrt
...
class CalibrateLinear(Node):
    def __init__(self, name):
        ...
        self.get_logger().info(
            "\033[1;32m%s\033[0m" % "Bring up rqt_reconfigure to control the test"
        )
        ...
        while True:
            ...
            if self.start_test:
                ...
                original_distance = sqrt(
                    pow((self.position.transform.translation.x - self.x_start), 2)
