...
def generate_launch_description():
    ...
    if compiled == "True":
        mentorpi_description_package_path = get_package_share_directory(
            "mentorpi_description"
        )
    else:
        mentorpi_description_package_path = (
            "/home/ubuntu/ros2_ws/src/simulations/mentorpi_description"
        )
    ...
    joint_state_publisher_node = Node(
        ...
        output="screen",
        parameters=[
            {"source_list": ["/controller_manager/joint_states"], "rate": 20.0}
        ],
    )
    ...
    rviz_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(mentorpi_description_package_path, "launch", "rviz.launch.py")
        ),
