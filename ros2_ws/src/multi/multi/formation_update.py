...
class FormationUpdate(Node):
    def __init__(self):
        ...
        self.master_name = (
            self.get_parameter("master_name").get_parameter_value().string_value
        )
        self.multi_mode = (
            self.get_parameter("multi_mode").get_parameter_value().string_value
        )
        ...
        self.srv_column = self.create_service(
            Trigger, "set_column", self.set_column_srv
        )
        self.srv_triangle = self.create_service(
            Trigger, "set_triangle", self.set_triangle_srv
        )
