...
| 그림 | 무엇을 보이는가 |
|---|---|
| ![배치 전수 탐색](../../docs/assets/vision/fig1_placement_sweep.png) | 30 mm 는 어느 배치에서도 20 px 에 못 닿는다 — FOV 를 만족하는 **2103 조합** 중 최대 17.4 px. 주황 점선이 가벽 가림 띠다 |
...
배치에서 우연히 나온 수치였고 확정 배치(377 mm)를 오히려 제외해 버렸다.
