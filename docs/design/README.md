...
| [`port_freeze.md`](port_freeze.md) | ⭐ **포트 시그니처 freeze (Tier-1)** — 확정 시그니처, 결정 9건, 미결 6건, 변경 절차·승인 |
...
| [`hld.md`](hld.md) | 인터페이스 명세 ⚠️ **갱신 대기** (M2, 8/20) — §4.5 포트 시그니처는 `port_freeze.md` 로 이관 |
