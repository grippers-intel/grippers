...
| 13 | **기준 ROS 2 배포판** — 호스트는 Jazzy, 실제 빌드·실행은 Humble 컨테이너로 이원화 | Humble 컨테이너 유지(현행) / Jazzy 네이티브 전환 / 양쪽 병기 명문화 | 8/14 | 조현우 · 이승용 |
