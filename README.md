...
>
> ⚠️ **루프 FSM과 포트 구조로의 마이그레이션은 완료됐지만 real perception 경로는 아직 미완입니다.**
> fake 기반 테스트 성공과 실제 인식 결과가 상자 투입까지 관통하는 End-to-end 성공을 구분합니다
> ([#195](https://github.com/grippers-intel/grippers/issues/195)).
>
> 📅 **현행 일정 (8/22 정합 감사)** — Notion §5-9 마지막 표를 단일 정본으로 사용합니다.
> M2 8/20–8/23 · 캡스톤 제출 8/22–8/23 · M3 8/26–9/1입니다.
> → [`milestones.md`](docs/ops/milestones.md)
...
| 🥈 **Target** | 4개 자율 반복 정리 + **범주 일반화(`toy` 형상 3종 · `chess` 기물 3종)** + 파지 재시도 + FETCH + 음성 | M3–M4 (9/1–9/4) |
...
> **최종 발표: 2026년 9월 8일 (화)** · 일정 정본: Notion 허브 §5-9 마지막 표

| 마일스톤 | 기간 | 핵심 완료 조건 |
|---|---|---|
| **M1 · 설계** | ~8/20 | 배치·하드웨어 상수 확정 · 카메라 A·B 실측 #89–#91 |
| **M2 · 모듈 프로토타입** | **8/20–8/23** | 실제 validation · 실기 어댑터 · HEF/Pi 런타임 Gate |
| **캡스톤 지원 제출** | **8/22–8/23** | 8/22 리허설·촬영 · 8/23 편집·PPT·제출 |
| **M3 · 실기 통합** | **8/26–9/1** | 실제 인식 기반 **1개 End-to-end 성공** · 실패 원인 분류 · 컷오프 |
| **M4 · MVP 검증** | **9/2–9/4** | 반복 정리 · 정량 측정 · 9/4 freeze |
| **M5 · 발표 준비** | **9/5–9/8** | 9/6 포스터 제출 · 9/7 최종 점검 · **9/8 발표** |
