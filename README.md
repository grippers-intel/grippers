...
- ⏸ **상자는 🟢 초록 · 🔵 파랑 2개로 확정했습니다 (8/20).** ⚫ 검정 · 🔴 빨강 방해 선택지는 쓰지 않습니다. 클래스를 늘릴 때 상자 · `placement_rule` 과 함께 다시 넣을 수 있도록 구조는 유지합니다.
- 검정 상자가 빠지면서 **LAB 세그멘테이션의 유일한 사각(⚫)이 사라졌습니다** — 밝은 테두리 · ArUco 병행 대책도 함께 불필요해집니다.
...
| 오배치 횟수 | **0회** | **상자 2개 (8/20 확정)** → 무작위 기준선 **50%.** 최대 위협은 원기둥 가베 ↔ 체스말(룩) 혼동 |
...
| **상자 2개** | 🟢 초록 · 🔵 파랑 · 바닥 0.40 × 0.40 m · **먼 쪽 양쪽 모서리** (벽 이격 0.05 · 상자 간 0.90 m) · ⚫🔴 는 ⏸ 미사용 | 발주 |
