...
class Ros2Perception(Perception):
    def __init__(self, node):
        ...
        self._clearance_client = node.create_client(MonitorClearance, 'perception/monitor_clearance')
    ...
    def monitor_clearance(self):
        ...
        return SimpleNamespace(
            front=res.front, left=res.left, right=res.right,
            top=res.top, contact_risk=res.contact_risk,
        )
